...
module.exports = function (_EventEmitter) {
  ...
  (0, _createClass3.default)(MessageIO, [{
    key: 'packetSize',
    value: function packetSize(_packetSize) {
      if (arguments.length > 0) {
        this.debug.log('Packet size changed from ' + this.outgoingMessageStream.packetSize + ' to ' + _packetSize);
        this.outgoingMessageStream.packetSize = _packetSize;
      }
